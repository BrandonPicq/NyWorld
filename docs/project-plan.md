...
- navigation clavier de l'editeur : onglets de section en roving tabindex, listes de contenu/diagnostics/references avec Up/Down + Enter, et modal de selection de coordonnees avec focus initial, Tab piege, Escape et retour de focus.
