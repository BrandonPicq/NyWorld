...
function QuestForm({
  ...
  return (
    <section className="editor-item-form" aria-label="Quest editor">
      ...
      <QuestObjectivesList quest={quest} />
...
function QuestObjectivesList({ quest }: { quest: QuestDef }) {
  return (
    <section className="editor-zone-section">
      <div className="editor-family__header">
        <h3>Objectives (read-only)</h3>
      ...
      {quest.objectives.length === 0 ? (
        ...
        <ul className="editor-zone-row-list">
          {quest.objectives.map((objective, index) => (
            <li className="editor-zone-row" key={`${objective.id}-${index}`}>
              <div className="editor-zone-row__head">
                <strong>{objective.id}</strong>
                <span>{objective.type}</span>
              </div>
              <p className="editor-zone-row__meta">{objective.description}</p>
            </li>
          ))}
        </ul>
      )}
